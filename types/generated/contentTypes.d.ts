...
export interface ApiAftercareProductAftercareProduct
  extends Struct.SingleTypeSchema {
  collectionName: 'aftercare_products';
  info: {
    displayName: 'Aftercare_Product';
    pluralName: 'aftercare-products';
    singularName: 'aftercare-product';
  };
  options: {
...
export interface ApiAftercareAftercare extends Struct.CollectionTypeSchema {
  collectionName: 'aftercares';
  info: {
    description: '';
    displayName: 'Aftercare';
    pluralName: 'aftercares';
    singularName: 'aftercare';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCartItemCartItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliveryFee: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<40>;
...
export interface ApiClothingProductClothingProduct
  extends Struct.SingleTypeSchema {
  collectionName: 'clothing_products';
  info: {
    displayName: 'Clothing_Product';
    pluralName: 'clothing-products';
    singularName: 'clothing-product';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::clothing-product.clothing-product'
    > &
      Schema.Attribute.Private;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Advert: Schema.Attribute.Component<'shared.advert', false>;
    Blogs: Schema.Attribute.Component<'shared.blog', false>;
    Category_Description: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featured: Schema.Attribute.Component<'shared.featured-product', false>;
    ...
    > &
      Schema.Attribute.Private;
    Popular_Categories: Schema.Attribute.Component<'shared.category', true>;
    publishedAt: Schema.Attribute.DateTime;
    Reviews: Schema.Attribute.Component<'shared.reviews', false>;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiJewelryProductJewelryProduct
  extends Struct.SingleTypeSchema {
  collectionName: 'jewelry_products';
  info: {
    description: '';
    displayName: 'Jewelry_Product';
...
export interface ApiJewelryJewelry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Nose-Ring', 'Tragus', 'Belly-Ring', 'Septum', 'Tongue-Ring']
    >;
    ...
    ItemType: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Jewelry'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::jewelry.jewelry'
    ...
    material: Schema.Attribute.Enumeration<
      ['Gold', 'Silver', 'Acrylic', 'Plastic', 'Stainless-Steel']
    >;
    name: Schema.Attribute.String;
    price: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    sizes: Schema.Attribute.Component<'shared.jewelry-size', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMerchandiseMerchandise extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    price: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    sizes: Schema.Attribute.Component<'shared.size', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cart: Schema.Attribute.Relation<'oneToOne', 'api::cart-item.cart-item'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    ...
    shipping_method: Schema.Attribute.Enumeration<
      ['ttpost', 'courier', 'websource', 'DHL']
    >;
    subtotal: Schema.Attribute.Decimal;
    tracking_number: Schema.Attribute.Text;
...
export interface ApiWaistbeadProductWaistbeadProduct
  extends Struct.SingleTypeSchema {
  collectionName: 'waistbead_products';
  info: {
    description: '';
    displayName: 'Waistbead_Product';
    pluralName: 'waistbead-products';
    singularName: 'waistbead-product';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiWaistbeadWaistbead extends Struct.CollectionTypeSchema {
  collectionName: 'waistbeads';
  info: {
    description: '';
    displayName: 'Waistbead';
    pluralName: 'waistbeads';
    singularName: 'waistbead';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    role_type: Schema.Attribute.Enumeration<['admin', 'customer']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::aftercare-product.aftercare-product': ApiAftercareProductAftercareProduct;
      'api::aftercare.aftercare': ApiAftercareAftercare;
      'api::article.article': ApiArticleArticle;
      'api::author.author': ApiAuthorAuthor;
      'api::blog.blog': ApiBlogBlog;
      'api::cart-item.cart-item': ApiCartItemCartItem;
      'api::category.category': ApiCategoryCategory;
      'api::clothing-product.clothing-product': ApiClothingProductClothingProduct;
      ...
      'api::waistbead-product.waistbead-product': ApiWaistbeadProductWaistbeadProduct;
      'api::waistbead.waistbead': ApiWaistbeadWaistbead;
